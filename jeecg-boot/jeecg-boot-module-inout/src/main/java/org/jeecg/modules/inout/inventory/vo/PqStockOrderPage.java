package org.jeecg.modules.inout.inventory.vo;
 ...
 */
@Data
@ApiModel(value="pq_stock_orderPage对象", description="采购订单")
public class PqStockOrderPage {
	...
	@ExcelCollection(name="采购订单商品")
	@ApiModelProperty(value = "采购订单商品")
	private List<PqStockOrderSku> pqStockOrderSkuList;
